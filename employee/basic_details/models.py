...
class Employee(models.Model):
    ...
    business_unit = models.ForeignKey(BusinessUnitSettings, on_delete = models.CASCADE,null=True)
    department = models.ForeignKey(DepartmentSettings, on_delete = models.CASCADE,null=True)
    designation = models.ForeignKey(DesignationSettings, on_delete = models.CASCADE,null=True)
